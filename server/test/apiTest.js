...
describe("Testing api/column", () => {
    ...
    it("Should receive a array of Median_House_Value data after POST to /api/column", () => {
        chai.request("http://localhost:4000")
            .post("/api/column")
            .send(request)
            .end((err, res) => {
    ...
    it("Should receive a array of Median_Income data after POST to /api/column", () => {
    ...
    it("Should receive a array of Median_Age data after POST to /api/column", () => {
    ...
    it("Should receive a array of Tot_Rooms data after POST to /api/column", () => {
    ...
    it("Should receive a array of Tot_Bedrooms data after POST to /api/column", () => {
    ...
    it("Should receive a array of Population data after POST to /api/column", () => {
    ...
    it("Should receive a array of Households data after POST to /api/column", () => {
    ...
    it("Should receive a array of Latitude data after POST to /api/column", () => {
    ...
    it("Should receive a array of Longitude data after POST to /api/column", () => {
    ...
    it("Should receive a array of Distance_to_coast data after POST to /api/column", () => {
    ...
    it("Should receive a array of Distance_to_LA data after POST to /api/column", () => {
    ...
    it("Should receive a array of Distance_to_SanDiego data after POST to /api/column", () => {
    ...
    it("Should receive a array of Distance_to_SanJose data after POST to /api/column", () => {
    ...
    it("Should receive a array of Distance_to_SanFrancisco data after POST to /api/column", () => {
    ...
    it("Should receive a array of ID data after POST to /api/column", () => {
    ...
    it("Should receive receive no results after invalid POST to /api/column", () => {

...
describe("Testing cache/", () => {
    it("Should receive a list of neighborhoods with the highest median values after GET to cache/highestMedianValue", () => {
        const params = "highestMedianValue"
        chai.request("http://localhost:4000")
            .get(`/cache/${params}`)
            .end((err, res) => {
                expect(err).to.be.null
    ...
    it("Should receive a list of neighborhoods with the lowest median values after GET to cache/lowestMedianValue", () => {
        const params = "lowestMedianValue"
        chai.request("http://localhost:4000")
            .get(`/cache/${params}`)
            .end((err, res) => {
                expect(err).to.be.null
    ...
    it("Should receive a list of neighborhoods with the closest distance to the coast after GET to cache/closestDistanceToCoast", () => {
        const params = "closestDistanceToCoast"
        chai.request("http://localhost:4000")
            .get(`/cache/${params}`)
            .end((err, res) => {
                expect(err).to.be.null
    ...
    it("Should receive a list of neighborhoods with the highest populations after GET to cache/highestPopulation", () => {
        const params = "highestPopulation"
        chai.request("http://localhost:4000")
            .get(`/cache/${params}`)
            .end((err, res) => {
                expect(err).to.be.null
